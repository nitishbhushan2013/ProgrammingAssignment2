...
#'This function creates a special "matrix" object that can cache its inverse. It basically store the getter and setter
#'of the matrix and its inverse matrix as a list.
